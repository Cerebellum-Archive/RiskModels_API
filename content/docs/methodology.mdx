...
| $\beta$ | Sensitivity coefficient: $\beta = Cov(r_s, r_f) / Var(r_f)$ |
| HR | Dollar amount of ETF per $1 of stock to neutralize factor exposure |
| ER | Variance fraction explained by factors: $1 - Var(\varepsilon) / Var(r)$ |
| $\lambda$ (link beta) | Beta between ETFs at different levels |
| Orthogonalization | Removing higher-level exposure from lower-level factors |
| $\varepsilon$ (residual) | Idiosyncratic return unexplained by any factor — stock-specific alpha |
